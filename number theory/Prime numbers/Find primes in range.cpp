...
vector <bool> segmented_sieve(int l, int r) {
	...
	//considering only [l,r] and not [1,r];
	vector <bool> arr(r - l + 1, true);

	for (auto x : prime) {//mark all mutiples of x in prime false in [l,r];
...
//if index i in arr is true means actual no.(i+l) is prime;
//i=0 -> l-l; i=1 -> l+1-l; i=2 -> l+2-l; and so on....
